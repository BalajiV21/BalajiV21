...
###  AI/DataEngineer | LLMs & Agentic AI Systems | RAG Pipelines
...
- **LLM Engineering** — Prompt engineering, fine-tuning, and integrating OpenAI, Ollama, and Hugging Face models
- **AI Automation** — ETL-integrated LLM agents, data quality copilots, and intelligent document analysis
